...
public class BlindService {
    ...
    public List<IoAction> processBlinds(List<UiAction> ioActions) {
    ...
    private IoAction processMqtt(UiAction ioAction, BlindDevice device) {
    ...
    private void processLocal(UiAction ioAction, BlindDevice device) {
        switch (ioAction.getAction()) {
            case UP:
